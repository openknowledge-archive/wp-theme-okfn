...
<div id="item-header-content">
	...
	<h2 class="fn"><a href="<?php bp_user_link() ?>"><?php bp_displayed_user_fullname() ?></a> <span class="highlight"><span class="padding">@<?php bp_displayed_user_username() ?></span></span></h2>
