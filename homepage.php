		      ...
		      <h1 class="entry-title">From sonnets to statistics, genes to geodata</h1>
					...
					<div id="projects_front" class="frontpage_listing">
						...
						<div class="entry-content">
							<div class="odd"><h4><a href="#" target="_blank">CKAN</a></h4><p>Summary linking to more. This is dummy text. Anything can go here! Short description of project, WG or anything else...</p></div>
							<div class="even"><h4><a href="#" target="_blank">Where Does My Money go?</a></h4><p>Summary linking to more. This is dummy text. Anything can go here! Short description of project, WG or anything else...</p></div>
							<div class="odd"><h4><a href="#" target="_blank">The Open Definition Site</a></h4><p>Summary linking to more. This is dummy text. Anything can go here! Short description of project, WG or anything else...</p></div>
				...
				<div id="about_front" class="frontpage_listing">
						<h1 class="entry-title">What is the Open Knowledge Foudation?</h1>
						<div class="entry-content">
				...
				<div id="community_front" class="frontpage_listing">
						<h1 class="entry-title">How to get involved?</h1>
						<div class="entry-content">
							<div class="odd"><h4><a href="#" target="_blank">OKFN Wiki</a></h4><p>Summary linking to more. This is dummy text. Anything can go here! Short description of project, WG or anything else...</p></div>
							<div class="even"><h4><a href="#" target="_blank">Weekly IRC Meetings</a></h4><p>Summary linking to more. This is dummy text. Anything can go here! Short description of project, WG or anything else...</p></div>
							<div class="odd"><h4><a href="#" target="_blank">Mailinglists</a></h4><p>Summary linking to more. This is dummy text. Anything can go here! Short description of project, WG or anything else...</p></div>
					...
					<div id="news_front" class="frontpage_listing">
					...
					<div id="events_front" class="frontpage_listing">
